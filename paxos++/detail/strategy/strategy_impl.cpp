...
#include "../server/server_view.hpp"
   ...
   boost::shared_ptr <struct state>             state)
{
   ...
   follower_connection->read_command (
      std::bind (&strategy_impl::receive_promise,
                 this,
                 std::placeholders::_1,
                 client_connection,
                 client_command,
...
{  
    ...
    */
   follower_connection->read_command (
      std::bind (&strategy_impl::receive_accepted,
                 this,
                 std::placeholders::_1,
                 client_connection,
                 client_command,
...
/*! virtual */ void
strategy_impl::receive_accepted (
   boost::optional <enum detail::error_code>    error,
   tcp_connection_ptr                           client_connection,
   detail::command                              client_command,
   boost::asio::ip::tcp::endpoint const &       follower_endpoint,
...
/*! virtual */ void
strategy_impl::add_local_host_information (
   quorum::server_view const &  quorum,
...
/*! virtual */ void
strategy_impl::process_remote_host_information (
   detail::command const &      command,

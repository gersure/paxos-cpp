...
public:   
   ...
   /*
     \brief Constructor
     \param io_context    References the OS'es underlying I/O services
     \param endpoint      Our endpoint so we can identify ourselves within the server
     \param configuration Our runtime configuration parameters

     This constructor assumes we are part of the server. This will automatically make
     sure our endpoint is added to the server.
    */
   server_view (
